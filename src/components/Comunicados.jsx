    ...
    return (
        <div className="flex flex-col justify-center items-center">
            ...
            <ul className="list-disc list-outside">
                ...
                <li className="my-5">
                Se recomienda a los jugadores que, usen un <Spam text="teclado 100%" /> para más comodidad, debido a que, el servidor contiene muchos mods con atajos de teclado o teclas que asignar para usar los mods.
                </li>
                <li className="my-5">
                Las personas que le digan a algún administrador, un bug, serán <Spam text="recompensados" />.
                </li>
                <li className="my-5">
                ...
                <li className="my-5">
                Ojo, cuando <Spam text="te infecte un zombie" /> (aunque sea el efecto de nivel 1), tendrás que encontrar una de las muchas curas que se implementaron: manzana dorada, manzana encantada, botella de miel, guiso de remolacha, estofado de conejo, papa venenosa, pez tropical y pez globo (También brinda efecto de inmunidad, pero durante 2 minutos). De lo contrario morirás.
                </li>
                <li className="my-5">
                Las personas que tengan cualquier tipo de pertenencias a más de la distancia establecida (<Spam text="10.000 bloques" />) del Overword, serán eliminadas. Los jugadores que encuentren esas pertenencias, se las pueden quedar. Si están o son cualquier tipo de objeto de almacenamiento reforzado o con código, pueden comunicarse con algún administrador para poder quedarse con todo el contenido dentro.
                </li>
                <li className="my-5">
                Cuando estás infectado, ten cuidado al utilizar el comando <Spam text="/lobby" />. En el lobby, no aparecen mobs debido a medidas de protección. Esto significa que si mueres estando infectado mientras estás en el lobby, perderás todo tu inventario.
                </li>
                <li className="my-5">
                ...
                <li className="my-5">
                Las personas podrán crear un equipo de máximo 4 personas con el comando <Spam text="/team create 'nombre del equipo'" />. Tener un equipo tiene varios beneficios, como por ejemplo: el daño entre los miembros del equipo está desactivado, nombre del equipo visible a todos los jugadores, disponibilidad administrar el team a la disposición del creador, etc.
                </li>
            </ul>
            </ParLeft>
        </div>
